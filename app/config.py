...
class Settings(BaseSettings):
    ...
    # LLM Features
    enable_llm_conversion: bool = False  # Disable LLM by default
    enable_smart_query_translation: bool = False
    enable_intelligent_mapping: bool = False

    # EDOT Browser / OTLP proxy
    otlp_endpoint: Optional[str] = None  # e.g. https://otel-demo-a5630c.apm.us-east-1.aws.elastic.cloud
    otlp_api_key: Optional[str] = None   # Elastic API key with APM ingest privileges
...
print(f"[DEBUG] LLM_ENABLED: {settings.enable_llm_conversion}")
